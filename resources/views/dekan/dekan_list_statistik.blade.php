...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
            <div>
                {{-- TOMBOL KEMBALI KE DASHBOARD DEKAN --}}
                            ...
                            @forelse($items as $index => $item)
                                ...
                                @if (in_array($kategori, ['total_usulan', 'disetujui', 'ditolak', 'menunggu']))
                                    <tr class="border-bottom">
                                        ...
                                        <td class="text-center py-3">
                                            {{-- ROUTE DETAIL DEKAN --}}
                                            <a href="{{ route('dekan.monitoring.detail', $item->id) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3 shadow-sm fw-bold">
                                                Detail
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                @else
                                    <tr class="border-bottom">
                                        ...
                                        <td class="py-3 text-muted small fw-semibold">{{ $item->proposal->skema_label ?? '-' }}</td>
                                        ...
                                        <td class="text-center py-3">
                                            {{-- ROUTE DETAIL DEKAN --}}
                                            <a href="{{ route('dekan.monitoring.detail', $item->proposal_id) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3 shadow-sm">
                                                Detail
                                            </a>
                                        </td>
                                    </tr>
