...
<div class="col-lg-5 col-md-6">
    <div class="d-flex flex-column gap-2 h-100">
        {{-- CARD 1: TOTAL USULAN (Icon: People Group / Data) --}}
        <a href="{{ route('wakil_dekan3.statistik.list', 'total_usulan') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    ...
                    {{-- Icon disamakan dengan Wakil Rektor --}}
        ...
        {{-- CARD 2: PROPOSAL DISETUJUI (Icon: Person Check) --}}
        <a href="{{ route('wakil_dekan3.statistik.list', 'proposal_disetujui') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
...
<div class="col-lg-4 col-md-6">
    <div class="d-flex flex-column gap-2 h-100">
        {{-- CARD 3: ARTIKEL (Icon: File Text) --}}
        <a href="{{ route('wakil_dekan3.statistik.list', 'artikel') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
        ...
        {{-- CARD 4: SERTIFIKAT (Icon: Book / Journal) --}}
        <a href="{{ route('wakil_dekan3.statistik.list', 'sertifikat') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
                    ...
                    {{-- Icon disamakan dengan Wakil Rektor (Menggunakan Book/Journal) --}}
        ...
        {{-- CARD 5: HKI (Icon: Award) --}}
        <a href="{{ route('wakil_dekan3.statistik.list', 'hki') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
