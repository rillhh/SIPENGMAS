...
@section('content')
    ...
    <div class="container">
            ...
            <div class="col-12">
                <div class="card text-white shadow-sm" style="background-color: #8BC3B4;">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text mb-0">Selamat datang, Administrator. Kelola sistem, pengguna, dan rekapitulasi data.</p>
                    </div>
                    <div class="p-4 pt-0">
                        <div class="row justify-content-center g-3">
                            
                            {{-- Tombol Aksi 1: Rekapitulasi --}}
                                ...
                                <a href="{{ route('admin.rekapitulasi') }}" class="text-decoration-none action-card-link">
                                    <div class="card shadow-sm action-card h-100" style="border-radius: 0.5rem; border: none;">
                                        <div class="card-body text-center p-4 position-relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#378a75" class="bi bi-clipboard-data-fill action-icon mx-auto mb-2" viewBox="0 0 16 16">
                                                <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0zm3 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5-.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5z"/>
                                                <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1A2.5 2.5 0 0 1 9.5 5h-3A2.5 2.5 0 0 1 4 2.5zM10 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-6 4a1 1 0 1 1-2 0 1 1 0 0 1 2 0m4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
                                            </svg>
                                            <h6 class="card-title mb-0 mt-2 action-title" style="color: #378a75;">Rekapitulasi Proposal</h6>
                                        </div>
                                    </div>
                                </a>
                            </div>

                            {{-- Tombol Aksi 2: Manajemen User --}}
                            <div class="col-lg-4 col-md-6">
                                <a href="{{ route('admin.manajemen_user') }}" class="text-decoration-none action-card-link">
                                    <div class="card shadow-sm action-card h-100" style="border-radius: 0.5rem; border: none;">
                                        <div class="card-body text-center p-4 position-relative">
                                            ...
                                            <h6 class="card-title mb-0 mt-2 action-title" style="color: #378a75;">Manajemen Akun</h6>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            {{-- Tombol Aksi 3: Customitazion --}}
                            <div class="col-lg-4 col-md-6">
                                <a href="{{ route('admin.customization') }}" class="text-decoration-none action-card-link">
                                    <div class="card shadow-sm action-card h-100" style="border-radius: 0.5rem; border: none;">
                                        <div class="card-body text-center p-4 position-relative">
                                        <svg fill="#378a75" xmlns="http://www.w3.org/2000/svg"  width="32" height="32" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve">
                                            <g>
                                            ...
                                            <h6 class="card-title mb-0 mt-2 action-title" style="color: #378a75;">Customization</h6>
                                        </div>
                                    </div>
                                </a>
                            </div>
        ...
        {{-- 2. Statistik & Profil (Layout 3 Kolom ala Wadek 3) --}}
        <div class="row mb-4">
            <div class="col-12">
                <h6 class="text-uppercase fw-bold text-secondary mb-3" style="letter-spacing: 1px; font-size: 0.9rem;">Statistik Sistem</h6>
                
                <div class="row g-3">
                    {{-- KOLOM 1 (KIRI): IDENTITAS --}}
                    ...
                    {{-- KOLOM 2 (TENGAH): STATISTIK UTAMA --}}
                    <div class="col-lg-5 col-md-6">
                        <div class="d-flex flex-column gap-2 h-100">
                            {{-- Card 1: Total Proposal --}}
                            
                            <a href="{{ route('admin.statistik.list', 'proposal_keseluruhan') }}" class="text-decoration-none flex-grow-1">
                            ...
                            <a href="{{ route('admin.statistik.list', 'proposal_didanai') }}" class="text-decoration-none flex-grow-1">
                                <div class="card shadow-sm h-100 stat-card">
                                    <div class="card-body p-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#8BC3B4" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/></svg>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    {{-- KOLOM 3 (KANAN): STATISTIK LUARAN --}}
                    <div class="col-lg-4 col-md-6">
                        <div class="d-flex flex-column gap-2 h-100">
                            <a href="{{ route('admin.statistik.list', 'artikel') }}" class="text-decoration-none flex-grow-1">
                                <div class="card shadow-sm h-100 stat-card">
                                    <div class="card-body p-3 d-flex justify-content-between align-items-center">
                                        <div>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#8BC3B4" class="bi bi-file-earmark-text-fill" viewBox="0 0 16 16"><path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM4.5 9a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1h-7zM4 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM4.5 12a.5.5 0 0 1 0-1h4a.5.5 0 0 1 0 1h-4z"/></svg>
                                    </div>
                                </div>
                            </a>
                            <a href="{{ route('admin.statistik.list', 'buku') }}" class="text-decoration-none flex-grow-1">
                                <div class="card shadow-sm h-100 stat-card">
                                    <div class="card-body p-3 d-flex justify-content-between align-items-center">
                                        <div>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#8BC3B4" class="bi bi-book-half" viewBox="0 0 16 16">
                                            <path d="M8.5 2.687c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z"/>
                                        </svg>
                                    </div>
                                </div>
                            </a>
                            <a href="{{ route('admin.statistik.list', 'hki') }}" class="text-decoration-none flex-grow-1">
                                <div class="card shadow-sm h-100 stat-card">
                                    <div class="card-body p-3 d-flex justify-content-between align-items-center">
                                        <div>
        ...
        {{-- 3. Panduan & Dokumen (Menggunakan Style Wadek 3) --}}
        <div class="row mb-4" style="margin-top: 10px;">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="text-uppercase fw-bold text-secondary mb-0" style="letter-spacing: 1px; font-size: 0.9rem;">KEBUTUHAN BERKAS DAN PANDUAN</h6>
                    {{-- TOMBOL UPLOAD DI HEADER --}}
                    <button class="btn btn-sm btn-success text-white fw-bold shadow-sm" data-bs-toggle="modal" data-bs-target="#modalUploadBerkas">
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                    <div class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="#8BC3B4" class="bi bi-file-earmark-pdf-fill me-3"
                                            viewBox="0 0 16 16">
                                    ...
                                    <div>
                                        ...
                                        {{-- Optional: Hapus --}}
                                        {{-- <form action="..." ... class="d-inline"><button ... class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></button></form> --}}
                                    </div>
                                </div>
                            @empty
    ...
    {{-- MODAL UPLOAD BERKAS --}}
    <div class="modal fade" id="modalUploadBerkas" tabindex="-1" aria-labelledby="modalUploadBerkasLabel" aria-hidden="true">
