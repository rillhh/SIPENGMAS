            ...
            <div class="col-12">
                <div class="card text-white shadow-sm" style="background-color: #8BC3B4; border: none;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="card-text mb-0">Selamat datang. Pantau kinerja fakultas dan validasi usulan kegiatan
                            pengabdian.</p>
                    </div>
                    ...
                    <div class="p-4 pt-0">
                        <div class="row justify-content-center g-3">
                            <div class="col-lg-4 col-md-5 col-sm-6">
                                <a href="{{ route('wakil_dekan3.validasi') }}"
                        ...
                        @if ($pendingProposals->count() > 0)
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            ...
                                            <span class="text-secondary" style="font-size: 1rem;">
                                                Status Proposal:
                                                <span
                                                    class="badge bg-warning bg-opacity-10 text-warning fs-6 px-3 py-1 ms-1">
                                                    Menunggu Validasi
                                                </span>
                                            </span>
                                        </div>
                                    ...
                                    {{-- Tombol Aksi --}}
                                    <a href="{{ route('wakil_dekan3.validasi.detail', $lastPending->id) }}"
