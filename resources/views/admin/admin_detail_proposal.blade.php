...
@section('content')
    ...
    <div class="container pb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">Detail Rekapitulasi Proposal</h4>
                <p class="text-muted mb-0">Mode tinjauan administrator (Read-Only).</p>
            </div>
            <a href="{{ url()->previous() }}" class="btn btn-secondary d-flex align-items-center shadow-sm">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-flex justify-content-end mt-1 mb-5">
                    <a href="{{ $detailProposal->status_progress >= 4 ? route('dosen.proposal.export_pdf', $detailProposal->id) : '#' }}"
                        ...
                        onclick="{{ $detailProposal->status_progress < 4 ? 'event.preventDefault(); showValidationAlert();' : '' }}">
    ...
    <script>
        function showValidationAlert() {
            Swal.fire({
                ...
                text: 'Lembar pengesahan hanya dapat didownload jika proposal sudah selesai (Status: Didanai).',
