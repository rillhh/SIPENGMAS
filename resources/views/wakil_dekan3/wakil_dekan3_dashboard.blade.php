...
@section('title', 'Dasbor Wakil Dekan III')
            ...
            <div class="col-12">
                <div class="card text-white shadow-sm" style="background-color: #8BC3B4; border: none;">
                    ...
                    <div class="card-body p-4">
                        <h5 class="card-title fw-bold">Dasbor Wakil Dekan III</h5>
                        <p class="card-text mb-0">Selamat datang. Pantau kinerja fakultas dan validasi usulan kegiatan pengabdian.</p>
                    </div>
                    ...
                    <div class="p-4 pt-0">
                        <div class="row justify-content-center g-3">
                            <div class="col-lg-4 col-md-5 col-sm-6">
                                <a href="{{ route('wakil_dekan3.validasi') }}" class="text-decoration-none action-card-link">
                                    <div class="card shadow-sm action-card h-100" style="border-radius: 0.5rem; border: none;">
                                        <div class="card-body text-center p-4 position-relative">
                                            ...
                                            <h6 class="card-title mb-0 mt-2 action-title" style="color: #378a75;">Validasi Proposal Masuk</h6>
                        ...
                        @if ($pendingProposals->count() > 0)
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            ...
                                            <span class="text-secondary" style="font-size: 1rem;">
                                                Tanggal Ajuan: <span class="fw-bold text-dark">{{ $lastPending->created_at->format('d-m-Y') }}</span>
                                            </span>
                                            ...
                                            <span class="text-secondary" style="font-size: 1rem;">
                                                Status Proposal:
                                                <span class="badge bg-warning bg-opacity-10 text-warning fs-6 px-3 py-1 ms-1">
                                                    Menunggu Validasi
                                                </span>
                                            </span>
                                        </div>
                                    ...
                                    {{-- Tombol Aksi --}}
                                    <a href="{{ route('wakil_dekan3.validasi.detail', $lastPending->id) }}" class="btn btn-outline-primary fw-bold px-4 py-2 ms-3 shadow-sm">
                                        Lihat Detail
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="card shadow-sm h-100 border-0">
                            <div class="card-body p-3 d-flex flex-column justify-content-center align-items-center text-center">
                                ...
                                <div class="mt-2 text-muted small">Wakil Dekan III</div>
                            </div>
                        </div>
                    </div>
                    
                    {{-- Partial Statistik --}}
                    @include('wakil_dekan3.partials.dashboard_stats_cards')
                </div>
            </div>
        </div>
    </div>
