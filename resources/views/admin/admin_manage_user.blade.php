...
<div class="container h-100">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-3">
            ...
            {{-- TOOLBAR: SEARCH DI KIRI, TAMBAH DI KANAN --}}
            <div class="d-flex justify-content-between align-items-center mb-3">
                
                {{-- KIRI: FORM PENCARIAN --}}
                <div class="col-md-5">
                    <form action="{{ route('admin.manajemen_user') }}" method="GET">
                        {{-- Simpan per_page agar tidak reset saat search --}}
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" name="search" placeholder="Cari data..." value="{{ request('search') }}">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($user->role === 'Dekan' || $user->role === 'Wakil Dekan')
                                    <span class="badge bg-warning text-dark" style="font-size: 0.75rem;">{{ $user->role }}</span>
                                @else
                                    <span class="badge bg-success" style="font-size: 0.75rem;">{{ $user->role }}</span>
                                @endif
                            </td>
                            <td>
                                <button class="btn btn-success btn-sm p-1 px-2 rounded-1" 
                                        title="Edit Akun"
            ...
            {{-- FOOTER: PAGINATION & TAMPILKAN PER HALAMAN --}}
            @if($users->total() > 0)
            <div class="d-flex justify-content-between align-items-center mt-3 pt-2 border-top">
                ...
                {{-- KANAN: Selector & Links --}}
                <div class="d-flex align-items-center gap-3">
                    <form action="{{ route('admin.manajemen_user') }}" method="GET" class="d-flex align-items-center">
            ...
            <form action="{{ route('admin.manajemen_user.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nidn" placeholder="12345678" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="fakultas_tambah" name="fakultas" onchange="updateProdi('tambah')">
        ...
        <div class="modal-content">
            ...
            <form id="formEditUser" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label fw-bold">NIDN</label>
                        <input type="text" class="form-control" id="edit_nidn" name="nidn" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Lengkap</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Fakultas</label>
                        <select class="form-select" id="fakultas_edit" name="fakultas" onchange="updateProdi('edit')">
                            <option value="Teknologi Informasi">Teknologi Informasi</option>
                            <option value="Kedokteran">Kedokteran</option>
                            <option value="Kedokteran Gigi">Kedokteran Gigi</option>
                            <option value="Ekonomi dan Bisnis">Ekonomi dan Bisnis</option>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Password Baru <small class="text-muted fw-normal">(Kosongkan jika tidak ingin ubah)</small></label>
                        <input type="text" class="form-control" name="password" placeholder="Isi hanya jika ingin ganti password">
                    </div>            
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
    ...
    function fillEditModal(user) {
        ...
        if (user.fakultas) {
            ...
            if(user.prodi) {
                ...
                document.getElementById('prodi_edit').innerHTML = '<option value="" disabled selected>-- Pilih Fakultas Dulu --</option>';
            }
        }
    }
</script>
...
@push('styles')
<style>
    /* CSS: Header Sticky & Scroll Body Only */
    .table-scroll-container {
        max-height: 65vh; /* Tinggi tabel sebelum scroll */
        overflow-y: auto; 
