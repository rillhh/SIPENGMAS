                            ...
                            @forelse($items as $index => $item)
                                ...
                                @if (in_array($kategori, ['total_usulan', 'proposal_disetujui']))
                                    <tr class="border-bottom">
                                        ...
                                        <td class="py-3">
                                            <div class="d-flex flex-column">
                                                ...
                                                <small class="text-muted">
                                                    <i class="bi bi-person-circle me-1"></i> {{ $item->user->name ?? 'Pengusul' }}
                                                </small>
                                            </div>
                                        </td>
                                        ...
                                        {{-- Accessor Skema --}}
                                        <td class="py-3">
                                            <span class="fw-bold text-dark small">{{ $item->skema_label }}</span>
                                        </td>

                                        {{-- Accessor Status --}}
                                        <td class="py-3 text-center">
                                            <span class="badge bg-{{ $item->status_color }} bg-opacity-10 text-{{ $item->status_color }} border border-{{ $item->status_color }} rounded-pill px-3">
                                                {{ $item->status_label }}
                                            </span>
                                        </td>
