...
@section('title', 'Detail Proposal - Kepala Pusat')

@section('content')
    {{-- SHARED ALERT & SWEETALERT --}}
    ...
    <div class="container pb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">Detail Validasi Proposal</h4>
                <p class="text-muted mb-0">Tinjau substansi proposal sebelum memberikan persetujuan.</p>
            </div>
            <a href="{{ route('kepala_pusat.validasi') }}" class="btn btn-secondary d-flex align-items-center shadow-sm">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-0">{{ $detailProposal->tahun_pelaksanaan }} ({{ $detailProposal->identitas->periode_kegiatan ?? 1 }} Tahun)</p>
                            </div>
                        </div>
                        <div class="mb-0">
            ...
            <div class="col-lg-4">
                ...
                {{-- PANEL VALIDASI (Hanya jika status == 2) --}}
                @if($detailProposal->status_progress == 2)
                    <div class="card shadow border-0 mb-4 bg-primary bg-opacity-10 border-primary">
                        <div class="card-body">
                            ...
                            <p class="small text-muted mb-3">Proposal ini menunggu persetujuan Anda sebagai Kepala Pusat.</p>
                            
                            <div class="d-grid gap-2">
                                <button class="btn btn-success fw-bold text-white shadow-sm" data-bs-toggle="modal" data-bs-target="#modalApproveKP">
                                    <i class="bi bi-check-circle-fill me-2"></i> Setujui Proposal
                                </button>
                                <button class="btn btn-danger fw-bold text-white shadow-sm" data-bs-toggle="modal" data-bs-target="#modalRejectKP">
                                    <i class="bi bi-x-circle-fill me-2"></i> Tolak Proposal
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    {{-- MODAL APPROVE/REJECT KHUSUS KEPALA PUSAT --}}
    @if($detailProposal->status_progress == 2)
        @include('kepala_pusat.partials.modal_action', ['proposal' => $detailProposal])
    @endif
