...
@section('title', 'Detail Monitoring Proposal - Dekan')
...
@section('content')
    ...
    <div class="container pb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">Detail Proposal Prodi</h4>
                <p class="text-muted mb-0">Detail informasi proposal pengabdian skala Prodi.</p>
            </div>
            {{-- ROUTE KEMBALI KE LIST MONITORING --}}
            <a href="{{ route('dekan.monitoring') }}" class="btn btn-secondary d-flex align-items-center shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button
                                ...
                                <div class="d-flex align-items-center">
                                    @if ($jmlArtikel > 0)
                                        <span class="badge bg-success text-white rounded-pill me-2">{{ $jmlArtikel }} File</span>
                                    @endif
                            ...
                            <button
                                ...
                                <div class="d-flex align-items-center">
                                    @if ($jmlSertifikat > 0)
                                        <span class="badge bg-success text-white rounded-pill me-2">{{ $jmlSertifikat }} File</span>
                                    @endif
                                    <i class="bi bi-chevron-right text-muted"></i>
                                </div>
                            </button>
                            ...
                            <button
                                ...
                                <div class="d-flex align-items-center">
                                    @if ($jmlHKI > 0)
                                        <span class="badge bg-success text-white rounded-pill me-2">{{ $jmlHKI }} File</span>
                                    @endif
                                    <i class="bi bi-chevron-right text-muted"></i>
                                </div>
                            </button>
