{{-- KOLOM TENGAH: STATISTIK USULAN --}}
<div class="col-lg-5 col-md-6">
    <div class="d-flex flex-column gap-2 h-100">
        {{-- CARD 1: TOTAL USULAN --}}
        <a href="{{ route('kepala_pusat.statistik.list', 'total_usulan') }}" class="text-decoration-none flex-grow-1">
        ...
        <a href="{{ route('kepala_pusat.statistik.list', 'proposal_disetujui') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
...
{{-- KOLOM KANAN: STATISTIK LUARAN --}}
<div class="col-lg-4 col-md-6">
    <div class="d-flex flex-column gap-2 h-100">
        {{-- CARD 3: ARTIKEL --}}
        <a href="{{ route('kepala_pusat.statistik.list', 'artikel') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
        ...
        {{-- CARD 4: SERTIFIKAT --}}
        <a href="{{ route('kepala_pusat.statistik.list', 'sertifikat') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
        ...
        {{-- CARD 5: HKI --}}
        <a href="{{ route('kepala_pusat.statistik.list', 'hki') }}" class="text-decoration-none flex-grow-1">
            <div class="card shadow-sm h-100 stat-card">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    <div>
