...
@section('content')
    ...
    <div class="container pb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('dosen.dashboard') }}" class="btn btn-secondary d-flex align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                {{-- Langsung tampilkan nama dari database --}}
            ...
            <div class="col-lg-4">
                ...
                @if (isset($statusUndanganSaya) && $statusUndanganSaya === 0 && isset($idUndanganSaya))
                    <div class="card shadow border-0 mb-4 bg-primary bg-opacity-10 border-primary">
                        <div class="card-body">
                            <h6 class="fw-bold text-primary mb-3"><i class="bi bi-shield-check me-2"></i>Keputusan Bergabung
                            </h6>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('dosen.anggota.terima', $idUndanganSaya) }}" method="POST">
                        ...
                        <div class="modal-body text-center p-4">
                            <div class="mb-3 text-success"><i class="bi bi-check-circle" style="font-size: 3rem;"></i>
                            </div>
    ...
    {{-- MODAL UPLOAD ARTIKEL/SERTIFIKAT/HKI (Jika perlu form upload manual, masukkan di sini) --}}
    {{-- ... Kode Form Upload Luaran ... --}}
