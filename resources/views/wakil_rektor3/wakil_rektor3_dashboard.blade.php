            ...
            <div class="col-12">
                <div class="card text-white shadow-sm" style="background-color: #8BC3B4;">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text mb-0">Selamat datang. Kelola validasi akhir dan pemantauan kegiatan pengabdian.</p>
                    </div>
                    <div class="p-4 pt-0">
                        <div class="row justify-content-center g-3">
                            <div class="col-lg-4 col-md-5 col-sm-6">
                                <a href="{{ route('wakil_rektor.validasi') }}" class="text-decoration-none action-card-link">
                                    <div class="card shadow-sm action-card h-100" style="border-radius: 0.5rem; border: none;">
                                        ...
                                        <div class="card-body text-center p-4 position-relative">
                                            ...
                                            <h6 class="card-title mb-0 mt-2 action-title" style="color: #378a75;">Validasi Proposal Akhir</h6>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom-0 pt-3 pb-2">
                        <h6 class="fw-bold mb-0 text-secondary text-uppercase"><i class="bi bi-clock-history me-2"></i>Menunggu Persetujuan Anda</h6>
                    </div>
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            ...
                                            <span class="text-secondary" style="font-size: 1rem;">
                                                Skema: <span class="fw-bold text-dark">{{ $lastPending->skema_label }}</span>
                                            </span>
                                    ...
                                    {{-- Tombol Aksi --}}
                                    <a href="{{ route('wakil_rektor.validasi.detail', $lastPending->id) }}" class="btn btn-outline-primary fw-bold px-4 py-2 ms-3 shadow-sm">
                                        Periksa
                                    </a>
                                </div>
                            </div>
